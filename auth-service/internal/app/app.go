...
func (a *App) RunApp() {
	...
	accountClientUrl := conf.AccountService.URL
	conn := a.setupGrpcClient(accountClientUrl)
	...
	// initialize module
	module.Initialize(conf, a.logger, conn)
	...
	fmt.Println("Account Service URL:", accountClientUrl)
	fmt.Println("---------------------------------------")
...
func (a *App) setupGrpcClient(url string) *grpc.ClientConn {
